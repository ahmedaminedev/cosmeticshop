...
import { ShoppableVideoCarousel } from '../ShoppableVideoCarousel'; // Import
...
export type AdSlot = {
    name: string;
    type: 'hero' | 'audioPromo' | 'promoBanner' | 'smallPromoBanners' | 'editorialCollage' | 'shoppableVideos'; // Update Type
    data: any;
    ...
    const handleSaveFromModal = (updatedData: any) => {
        ...
        switch(editingSlot.type) {
            ...
            case 'editorialCollage':
                 newAds.editorialCollage = updatedData;
                break;
            case 'shoppableVideos': // Case for new type
                 newAds.shoppableVideos = updatedData;
                break;
        }
        ...
        <div>
            ...
            <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6 border border-gray-200 dark:border-gray-700">
                <div className="max-w-7xl mx-auto space-y-12">
                    ...
                    {/* Editable wrapper for Shoppable Videos */}
                    <EditableAdWrapper slotName="Vidéos Shopping" onEdit={() => handleOpenModal({ name: 'Vidéos Shopping (Reels)', type: 'shoppableVideos', data: currentAds.shoppableVideos || [] })}>
                        <ShoppableVideoCarousel videos={currentAds.shoppableVideos || []} isPreview />
                    </EditableAdWrapper>
                    
                    <EditableAdWrapper slotName="Collage Éditorial (Masonry)" onEdit={() => handleOpenModal({ name: 'Collage Éditorial', type: 'editorialCollage', data: currentAds.editorialCollage || [] })}>
                        <EditorialMasonry items={currentAds.editorialCollage || []} isPreview />
                    </EditableAdWrapper>
