...
export const Logo: React.FC = () => (
    <div className="flex items-center gap-2 select-none group">
        <div className="relative w-8 h-8 flex items-center justify-center">
            ...
            <svg viewBox="0 0 24 24" fill="none" className="w-8 h-8 text-rose-500 dark:text-rose-400 transition-transform duration-500 group-hover:rotate-45" xmlns="http://www.w3.org/2000/svg">
