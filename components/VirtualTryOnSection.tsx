    ...
    return (
        <section className="relative w-full bg-white dark:bg-gray-900 py-16 md:py-24 overflow-hidden my-16 border-t border-rose-50 dark:border-gray-800">
            ...
            <div className="absolute left-0 top-1/2 -translate-y-1/2 -translate-x-10 md:translate-x-0 w-1/3 md:w-1/4 h-full max-w-[300px] pointer-events-none opacity-90">
                 <img
                    src="https://images.unsplash.com/photo-1625093742435-09869634721c?q=80&w=600&auto=format&fit=crop"
                    alt="Lipstick Swatch Left"
            ...
            <div className="absolute right-0 top-1/2 -translate-y-1/2 translate-x-10 md:translate-x-0 w-1/3 md:w-1/4 h-full max-w-[300px] pointer-events-none opacity-90">
                <img
                    src="https://images.unsplash.com/photo-1591360236480-943049ceab63?q=80&w=600&auto=format&fit=crop"
                    alt="Lipstick Swatch Right"
            ...
            <div className="relative z-10 max-w-2xl mx-auto text-center px-6">
                ...
                <p className="text-gray-600 dark:text-gray-300 text-lg md:text-xl mb-10 font-light leading-relaxed">
                    Essayez rouges à lèvres, fards à joues et plus encore pour découvrir votre nouvelle teinte préférée.
                </p>
                
                <button className="group relative inline-flex items-center gap-3 px-10 py-5 bg-transparent overflow-hidden rounded-full transition-all duration-300 hover:shadow-[0_0_40px_-5px_rgba(225,29,72,0.4)] hover:-translate-y-1">
                    {/* Gradient Background */}
                    ...
                    <div className="relative flex items-center gap-3 text-white">
                        <span className="font-bold uppercase tracking-[0.2em] text-xs">Découvrir maintenant</span>
